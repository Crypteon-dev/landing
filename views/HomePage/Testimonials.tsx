...
const TESTIMONIALS = [
  {
    content: `It's a really good product! There's a lot of people supporting my project, the contributors are getting more involved on the project!`,
    author: {
      name: 'Nicolas Lopes',
      title: 'Crypteon Core Committer',
